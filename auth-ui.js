// auth-ui.js
// Shared authentication and UI logic for all dashboard pages.
// Handles: auth guard, dynamic profile, dates, logout, hamburger menu.
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ─── LOGOUT HANDLER ────────────────────────────────────
  // Properly clear all auth tokens before navigating to login
  ...
  // Automatically set the correct nav link as active based on current URL
